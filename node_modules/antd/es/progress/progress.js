        ...
        value: function render() {
            ...
            if (showInfo) {
                ...
                if (format || progressStatus !== 'exception' && progressStatus !== 'success') {
                    ...
                    text = React.createElement(Icon, { type: 'close' + iconType, theme: type === 'line' ? 'filled' : 'outlined' });
                } else if (progressStatus === 'success') {
                    text = React.createElement(Icon, { type: 'check' + iconType, theme: type === 'line' ? 'filled' : 'outlined' });
                }
