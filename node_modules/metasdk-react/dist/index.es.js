import React, { Component, Children, isValidElement, cloneElement, PureComponent, createElement } from 'react';
...
function (_Component) {
  ...
  function AutoControlledComponent() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "trySetState", function (maybeState, state) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        var illegalKeys = difference_1(keys_1(maybeState), autoControlledProps);

        if (!isEmpty_1(illegalKeys)) {
    ...
    var _state = invoke_1(assertThisInitialized(assertThisInitialized(_this)), 'getInitialAutoControlledState', _this.props) || {};
    ...
    if (process.env.NODE_ENV !== 'production') {
      ...
      var illegalDefaults = intersection_1(_autoControlledProps, keys_1(defaultProps));

      if (!isEmpty_1(illegalDefaults)) {
      ...
      var illegalAutoControlled = filter_1(_autoControlledProps, function (prop) {
        return startsWith_1(prop, 'default');
      });

      if (!isEmpty_1(illegalAutoControlled)) {
    ...
    var initialAutoControlledState = _autoControlledProps.reduce(function (acc, prop) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        if (!isUndefined_1(_this.props[defaultPropName]) && !isUndefined_1(_this.props[prop])) {
  ...
  createClass(AutoControlledComponent, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var newState = autoControlledProps.reduce(function (acc, prop) {
        var isNextUndefined = isUndefined_1(nextProps[prop]);

        var propWasRemoved = !isUndefined_1(_this2.props[prop]) && isNextUndefined; // if next is defined then use its value
...
var getChildMapping = function getChildMapping(children) {
  return keyBy_1(filter_1(Children.toArray(children), isValidElement), 'key');
};
...
var someByType = function someByType(children, type) {
  return some_1(Children.toArray(children), {
    type: type
  });
};
/**
...
var suggest = function suggest(suggestions) {
  ...
  var findBestSuggestions = memoize$1(function (str) {
    var propValueWords = str.split(' ');
    return flow$1(map$1(function (suggestion) {
      var suggestionWords = suggestion.split(' ');

      var propValueScore = flow$1(map$1(function (x) {
        return map$1(function (y) {
          return leven$1(x, y);
        }, suggestionWords);
      }), map$1(min$1), sum$1)(propValueWords);

      var suggestionScore = flow$1(map$1(function (x) {
        return map$1(function (y) {
          return leven$1(x, y);
        }, propValueWords);
      }), map$1(min$1), sum$1)(suggestionWords);

      return {
        suggestion: suggestion,
        score: propValueScore + suggestionScore
      };
    }), sortBy$1(['score', 'suggestion']), take$1(3))(suggestions);
  });
...
var disallow = function disallow(disallowedProps) {
  return function (props, propName, componentName) {
    ...
    if (isNil$2(props[propName]) || props[propName] === false) return; // find disallowed props with values

    var disallowed = disallowedProps.reduce(function (acc, disallowedProp) {
      if (!isNil$2(props[disallowedProp]) && props[disallowedProp] !== false) {
        return toConsumableArray(acc).concat([disallowedProp]);
      }
...
var some$1 = function some(validators) {
  return function (props, propName, componentName) {
    ...
    var errors = compact$1(map$1(validators, function (validator) {
    ...
    if (errors.length === validators.length) {
      ...
      error.message += "\n".concat(map$1(errors, function (err, i) {
...
var givenProps = function givenProps(propsShape, validator) {
  return function (props, propName, componentName) {
    ...
    var shouldValidate = keys$1(propsShape).every(function (key) {
    ...
    if (error) {
      ...
      var prettyProps = "{ ".concat(keys$1(pick$1(keys$1(propsShape), props)).map(function (key) {
        var val = props[key];
        var renderedValue = val;
        if (typeof val === 'string') renderedValue = "\"".concat(val, "\"");else if (Array.isArray(val)) renderedValue = "[".concat(val.join(', '), "]");else if (isObject$1(val)) renderedValue = '{...}';
...
var multipleProp = function multipleProp(possible) {
  return function (props, propName, componentName) {
    ...
    if (isNil$2(propValue) || propValue === false) return;
    var values = propValue.replace('large screen', 'large-screen').replace(/ vertically/g, '-vertically').split(' ').map(function (val) {
      return trim$1(val).replace('-', ' ');
    });

    var invalid = difference$1(values, possible); // fail only if there are invalid values
...
function () {
  ...
  createClass(EventSet, [{
    ...
    value: function dispatchEvent(event, dispatchAll) {
      ...
      var recentHandler = toConsumableArray(this.handlers).pop();
...
defineProperty(EventPool, "createByType", function (poolName, eventType, eventHandlers) {
...
function () {
  ...
  function EventTarget(target) {
    ...
    defineProperty(this, "handlers", new Map());

    defineProperty(this, "pools", new Map());

    defineProperty(this, "createEmitter", function (eventType, eventPools) {
...
var normalizeHandlers = function normalizeHandlers(handlers) {
  return isArray_1(handlers) ? handlers : [handlers];
};
...
function () {
  function EventStack() {
    ...
    classCallCheck(this, EventStack);

    defineProperty(this, "targets", new Map());

    defineProperty(this, "getTarget", function (target) {
    ...
    defineProperty(this, "removeTarget", function (target) {
      _this.targets.delete(normalizeTarget(target));
    });
  }

  createClass(EventStack, [{
    key: "sub",
...
function createShorthand(Component$$1, mapValueToProps, val) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

  if (typeof Component$$1 !== 'function' && typeof Component$$1 !== 'string') {
  ...
  if (!valIsFunction && !valIsReactElement && !valIsPropsObject && !valIsPrimitiveValue) {
    if (process.env.NODE_ENV !== 'production') {
      console.error(['Shorthand value must be a string|number|array|object|ReactElement|function.', ' Use null|undefined|boolean for none', " Received ".concat(_typeof_1(val), ".")].join(''));
    }
  ...
  if (valIsPrimitiveValue || valIsPropsObject) return React.createElement(Component$$1, props); // Call functions with args similar to createElement()

  if (valIsFunction) return val(Component$$1, props, props.children);
...
function createShorthandFactory(Component$$1, mapValueToProps) {
  if (typeof Component$$1 !== 'function' && typeof Component$$1 !== 'string') {
    throw new Error('createShorthandFactory() Component must be a string or function.');
  }

  return function (val, options) {
    return createShorthand(Component$$1, mapValueToProps, val, options);
  };
} // ============================================================
// HTML Factories
// ============================================================
 ...
 */
var getUnhandledProps = function getUnhandledProps(Component$$1, props) {
  // Note that `handledProps` are generated automatically during build with `babel-plugin-transform-react-handled-props`
  var _Component$handledPro = Component$$1.handledProps,
 ...
 */
function getElementType(Component$$1, props, getDefault) {
  var _Component$defaultPro = Component$$1.defaultProps,
...
var createComplexRange = function createComplexRange(options, pageFactory) {
  ...
  return toConsumableArray(firstGroup).concat([createInnerPrefix(firstGroupEnd, innerGroupStart, pageFactory)], toConsumableArray(innerGroup), [createInnerSuffix(innerGroupEnd, lastGroupStart, pageFactory)], toConsumableArray(lastGroup)).filter(Boolean);
};
...
var WIDTHS = toConsumableArray(keys_1(numberToWordMap)).concat(toConsumableArray(keys_1(numberToWordMap).map(Number)), toConsumableArray(values_1(numberToWordMap)));
...
var ICONS_AND_ALIASES = uniq_1(toConsumableArray(ICONS).concat(ICON_ALIASES)); // Some icon names are not part of icons.css.
...
var ALL_ICONS_IN_ALL_CONTEXTS = uniq_1(toConsumableArray(ICONS_AND_ALIASES).concat(COMPONENT_CONTEXT_SPECIFIC_ICONS));
...
function IconGroup(props) {
  ...
  return React.createElement(ElementType, _extends_1({}, rest, {
    className: classes
...
IconGroup.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  size: PropTypes.oneOf(without_1(SIZES, 'medium'))
} : {};
...
function (_PureComponent) {
  ...
  createClass(Icon, [{
    ...
    value: function render() {
      ...
      var classes = classnames(color, name, size, useKeyOnly(bordered, 'bordered'), useKeyOnly(circular, 'circular'), useKeyOnly(corner, 'corner'), useKeyOnly(disabled, 'disabled'), useKeyOnly(fitted, 'fitted'), useKeyOnly(inverted, 'inverted'), useKeyOnly(link, 'link'), useKeyOnly(loading, 'loading'), useValueAndKey(flipped, 'flipped'), useValueAndKey(rotated, 'rotated'), 'icon', className);
      var rest = getUnhandledProps(Icon, this.props);
      var ElementType = getElementType(Icon, this.props);
      var ariaOptions = this.getIconAriaOptions();
      return React.createElement(ElementType, _extends_1({}, rest, ariaOptions, {
        className: classes
      }));
    }
  }]);
...
/*#__PURE__*/
function (_Component) {
  inherits(Ref, _Component);

  function Ref() {
    classCallCheck(this, Ref);

    return possibleConstructorReturn(this, getPrototypeOf(Ref).apply(this, arguments));
  }
...
defineProperty(Ref, "handledProps", ["children", "innerRef"]);
...
function (_Component) {
  ...
  function PortalInner() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleRef", function (c) {
      return _this.ref = c;
    });
  ...
  createClass(PortalInner, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      invoke_1(this.props, 'onMount', null, objectSpread({}, this.props, {
        node: this.ref
      }));
    }
  }, {
    ...
    value: function componentWillUnmount() {
      invoke_1(this.props, 'onUnmount', null, objectSpread({}, this.props, {
        node: this.ref
      }));
    }
  }, {
...
defineProperty(PortalInner, "handledProps", ["children", "mountNode", "onMount", "onUnmount"]);
...
function (_Component) {
  ...
  function Portal() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleDocumentClick", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalMouseLeave", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalMouseEnter", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerBlur", function (e) {
      ...
      invoke_1.apply(void 0, [trigger, 'props.onBlur', e].concat(rest)); // do not close if focus is given to the portal


      var didFocusPortal = invoke_1(assertThisInitialized(assertThisInitialized(_this)), 'portalNode.contains', e.relatedTarget);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerClick", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerFocus", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerMouseLeave", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerMouseEnter", function (e) {
      clearTimeout(_this.mouseLeaveTimer);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "open", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "openWithTimeout", function (e, delay) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "close", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "closeWithTimeout", function (e, delay) {
      // React wipes the entire event object and suggests using e.persist() if
      // you need the event for async access. However, even with e.persist
      // certain required props (e.g. currentTarget) are null so we're forced to clone.
      var eventClone = objectSpread({}, e);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleMount", function (e, _ref) {
      var target = _ref.node;
      var eventPool = _this.props.eventPool;
      _this.portalNode = target;
      instance.sub('mouseleave', _this.handlePortalMouseLeave, {
        pool: eventPool,
        target: target
      });
      instance.sub('mouseenter', _this.handlePortalMouseEnter, {
        pool: eventPool,
        target: target
      });
      ...
      instance.sub('keydown', _this.handleEscape, {
        pool: eventPool
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleUnmount", function (e, _ref2) {
      var target = _ref2.node;
      var eventPool = _this.props.eventPool;
      _this.portalNode = null;
      instance.unsub('mouseleave', _this.handlePortalMouseLeave, {
        pool: eventPool,
        target: target
      });
      instance.unsub('mouseenter', _this.handlePortalMouseEnter, {
        pool: eventPool,
        target: target
      });
      ...
      instance.unsub('keydown', _this.handleEscape, {
        pool: eventPool
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerRef", function (c) {
      _this.triggerNode = c;

      invoke_1(_this.props, 'triggerRef', c);
    });
...
function (_Component) {
  ...
  function DimmerInner() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleContentRef", function (c) {
...
function (_Component) {
  ...
  function Dimmer() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalMount", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalUnmount", function () {
      if (!isBrowser()) return; // Heads up, IE doesn't support second argument in add()
  ...
  createClass(Dimmer, [{
    ...
    value: function render() {
      ...
      if (page) {
        ...
        }, React.createElement(DimmerInner, _extends_1({}, rest, {
          active: active,
          page: page
        })));
      }

      return React.createElement(DimmerInner, _extends_1({}, rest, {
        active: active,
        page: page
      }));
    }
...
function Image(props) {
  ...
  if (ElementType === 'img') {
    return React.createElement(ElementType, _extends_1({}, rootProps, imgTagProps, {
      className: classes
    }));
  }

  return React.createElement(ElementType, _extends_1({}, rootProps, {
    className: classes,
    href: href
...
function (_Component) {
  ...
  function Label() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleIconOverrides", function (predefinedProps) {
      return {
  ...
  createClass(Label, [{
    ...
    value: function render() {
      ...
      return React.createElement(ElementType, _extends_1({
        className: classes,
        onClick: this.handleClick
...
defineProperty(Label, "handledProps", ["active", "as", "attached", "basic", "children", "circular", "className", "color", "content", "corner", "detail", "empty", "floating", "horizontal", "icon", "image", "onClick", "onRemove", "pointing", "removeIcon", "ribbon", "size", "tag"]);
...
function (_Component) {
  ...
  function Button() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeElementType", function () {
      var _this$props = _this.props,
          attached = _this$props.attached,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeTabIndex", function (ElementType) {
      var _this$props2 = _this.props,
          disabled = _this$props2.disabled,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "focus", function () {
      return invoke_1(_this.ref, 'focus');
    });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "hasIconClass", function () {
      var _this$props3 = _this.props,
...
Button.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  color: PropTypes.oneOf(toConsumableArray(COLORS).concat(['facebook', 'google plus', 'instagram', 'linkedin', 'twitter', 'vk', 'youtube'])),
...
var getNodeFromProps = function getNodeFromProps(props) {
  ...
  if (isBrowser()) {
    if (isNil_1(node)) return document.body;
    return node;
  }
};
...
var NodeRegistry = function NodeRegistry() {
  ...
  defineProperty(this, "add", function (node, component) {
  ...
  defineProperty(this, "del", function (node, component) {
  ...
  defineProperty(this, "emit", function (node, callback) {
...
function (_Component) {
  ...
  function ModalActions() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleButtonOverrides", function (predefinedProps) {
      return {
...
function (_Component) {
  ...
  function Modal() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getMountNode", function () {
      return isBrowser() ? _this.props.mountNode || document.body : null;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleActionsOverrides", function (predefinedProps) {
      return {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleClose", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleOpen", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalMount", function (e) {
      var eventPool = _this.props.eventPool;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalUnmount", function (e) {
      var eventPool = _this.props.eventPool;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleDimmerRef", function (c) {
      return _this.dimmerRef = c;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setDimmerNodeStyle", function () {
      if (_this.dimmerRef) {
        _this.dimmerRef.style.setProperty('display', 'flex', 'important');
      }
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setPositionAndClassNames", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderContent", function (rest) {
      var _this$props = _this.props,
          actions = _this$props.actions,
          basic = _this$props.basic,
          children = _this$props.children,
      ...
      var classes = classnames('ui', size, useKeyOnly(basic, 'basic'), useKeyOnly(scrolling, 'scrolling'), 'modal transition visible active', className);
      ...
      if (!isNil(children)) {
        ...
        }, React.createElement(ElementType, _extends_1({}, rest, {
          className: classes,
          style: objectSpread({
            marginTop: marginTop
          }, style)
  ...
  createClass(Modal, [{
    ...
    value: function render() {
      ...
      return React.createElement(Portal, _extends_1({
...
function (_Component) {
  ...
  function Confirm() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleCancel", function (e) {
      invoke_1(_this.props, 'onCancel', e, _this.props);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleCancelOverrides", function (predefinedProps) {
      return {
        onClick: function onClick(e, buttonProps) {
          invoke_1(predefinedProps, 'onClick', e, buttonProps);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleConfirmOverrides", function (predefinedProps) {
      return {
        onClick: function onClick(e, buttonProps) {
          invoke_1(predefinedProps, 'onClick', e, buttonProps);
  ...
  createClass(Confirm, [{
    ...
    value: function render() {
      ...
      return React.createElement(Modal, _extends_1({}, rest, openProp, {
        size: size,
...
function (_Component) {
  ...
  function Menu() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleItemOverrides", function (predefinedProps) {
      return {
...
Menu.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  size: PropTypes.oneOf(without_1(SIZES, 'medium', 'big')),
...
function (_Component) {
  ...
  function PaginationItem() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleClick", function (e) {
      ...
      if (type !== 'ellipsisItem') invoke_1(_this.props, 'onClick', e, _this.props);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleKeyDown", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleOverrides", function () {
      return {
...
function (_Component) {
  ...
  function Pagination() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleItemClick", function (e, _ref) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleItemOverrides", function (active, type, value) {
  ...
  createClass(Pagination, [{
    ...
    value: function render() {
      ...
      return React.createElement(Menu, _extends_1({}, rest, {
...
defineProperty(Pagination, "handledProps", ["activePage", "aria-label", "boundaryRange", "defaultActivePage", "ellipsisItem", "firstItem", "lastItem", "nextItem", "onPageChange", "pageItem", "prevItem", "siblingRange", "totalPages"]);
...
function (_Component) {
  ...
  function Checkbox() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "canToggle", function () {
      var _this$props = _this.props,
          disabled = _this$props.disabled,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeTabIndex", function () {
      var _this$props2 = _this.props,
          disabled = _this$props2.disabled,
          tabIndex = _this$props2.tabIndex;
      if (!isNil_1(tabIndex)) return tabIndex;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleContainerClick", function (e) {
      var id = _this.props.id;
      if (isNil_1(id)) _this.handleClick(e);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleInputClick", function (e) {
      var id = _this.props.id;
      if (id) _this.handleClick(e);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleInputRef", function (c) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleMouseDown", function (e) {
      ...
      invoke_1(_this.inputRef, 'focus');

      e.preventDefault();
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setIndeterminate", function () {
  ...
  createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      }), React.createElement("input", _extends_1({}, htmlInputProps$$1, {
        checked: checked,
        className: "hidden",
        disabled: disabled,
        id: id,
...
defineProperty(Checkbox, "handledProps", ["as", "checked", "className", "defaultChecked", "defaultIndeterminate", "disabled", "fitted", "id", "indeterminate", "label", "name", "onChange", "onClick", "onMouseDown", "radio", "readOnly", "slider", "tabIndex", "toggle", "type", "value"]);
...
function Radio(props) {
  ...
  return React.createElement(Checkbox, _extends_1({}, rest, {
    type: type,
    radio: radio,
    slider: slider,
    toggle: toggle
...
function (_Component) {
  ...
  function Responsive() {
    ...
    _this = possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf(Responsive)).call.apply(_getPrototypeOf2, [this].concat(_args)));

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "fitsMaxWidth", function () {
      var maxWidth = _this.props.maxWidth;
      var width = _this.state.width;
      return isNil_1(maxWidth) ? true : width <= maxWidth;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "fitsMinWidth", function () {
      var minWidth = _this.props.minWidth;
      var width = _this.state.width;
      return isNil_1(minWidth) ? true : width >= minWidth;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setSafeState", function () {
      var _this2;

      return _this.mounted && (_this2 = _this).setState.apply(_this2, arguments);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "isVisible", function () {
      return _this.fitsMinWidth() && _this.fitsMaxWidth();
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleResize", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleUpdate", function (e) {
      _this.ticking = false;
    ...
    _this.state = {
      width: invoke_1(_this.props, 'getWidth')
    };
    return _this;
  }
...
function (_Component) {
  ...
  function DropdownSearchInput() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleRef", function (c) {
      return invoke_1(_this.props, 'inputRef', c);
    });
  ...
  createClass(DropdownSearchInput, [{
    ...
    value: function render() {
      ...
      return React.createElement("input", _extends_1({}, rest, {
...
defineProperty(DropdownSearchInput, "handledProps", ["as", "autoComplete", "className", "inputRef", "tabIndex", "type", "value"]);
...
function (_Component) {
  ...
  function Dropdown() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleChange", function (e, value) {
      invoke_1(_this.props, 'onChange', e, objectSpread({}, _this.props, {
        value: value
      }));
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "closeOnChange", function (e) {
      var _this$props = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "closeOnEscape", function (e) {
      if (keyboardKey_1.getCode(e) !== keyboardKey_1.Escape) return;
      e.preventDefault();
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "moveSelectionOnKeyDown", function (e) {
      var _moves;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "openOnSpace", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "openOnArrow", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "makeSelectedItemActive", function (e) {
      var open = _this.state.open;
      var multiple = _this.props.multiple;

      var item = _this.getSelectedItem();

      var value = get_1(item, 'value'); // prevent selecting null if there was no selected item value
      // prevent selecting duplicate items when the dropdown is closed


      if (isNil_1(value) || !open) return; // state value may be undefined

      var newValue = multiple ? union_1(_this.state.value, [value]) : value; // notify the onChange prop that the user is trying to change value
      ...
      if (item['data-additional']) invoke_1(_this.props, 'onAddItem', e, objectSpread({}, _this.props, {
        value: value
      }));
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "selectItemOnEnter", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "removeItemOnBackspace", function (e) {
      var _this$props3 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "closeOnDocumentClick", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "attachHandlersOnOpen", function () {
      instance.sub('keydown', [_this.closeOnEscape, _this.moveSelectionOnKeyDown, _this.selectItemOnEnter, _this.removeItemOnBackspace]);
      instance.sub('click', _this.closeOnDocumentClick);
      instance.unsub('keydown', [_this.openOnArrow, _this.openOnSpace]);
    });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleDocumentMouseUp", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleIconClick", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleItemClick", function (e, item) {
      var _this$props5 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleFocus", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleBlur", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleSearchChange", function (e, _ref) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getMenuOptions", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getSelectedItem", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getEnabledIndices", function (givenOptions) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getItemByValue", function (value) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getMenuItemIndexByValue", function (value, givenOptions) {
      var options = givenOptions || _this.getMenuOptions();

      return findIndex_1(options, ['value', value]);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getDropdownAriaOptions", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "clearSearchQuery", function () {
      _this.trySetState({
        searchQuery: ''
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setValue", function (value) {
      _this.trySetState({
        value: value
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setSelectedIndex", function () {
      var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.state.value;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleLabelClick", function (e, labelProps) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleLabelRemove", function (e, labelProps) {
      // prevent focusing search input on click
      e.stopPropagation();
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "moveSelectionBy", function (offset) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleSearchRef", function (c) {
      return _this.searchRef = c;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleSizerRef", function (c) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeSearchInputTabIndex", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeSearchInputWidth", function () {
      var searchQuery = _this.state.searchQuery;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "scrollSelectedItemIntoView", function () {
      if (!_this.ref) return;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setOpenDirection", function () {
      if (!_this.ref) return;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "toggle", function (e) {
      return _this.state.open ? _this.close(e) : _this.open(e);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderText", function () {
      ...
      var hasValue = multiple ? !isEmpty_1(value) : !isNil_1(value) && value !== '';
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderSearchInput", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderSearchSizer", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderLabels", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderOptions", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderMenu", function () {
      ...
      if (!isNil(children)) {
        ...
        return cloneElement(menuChild, objectSpread({
          className: className
        }, ariaOptions));
      }

      return React.createElement(DropdownMenu, _extends_1({}, ariaOptions, {
        direction: direction,
        open: open
  ...
  createClass(Dropdown, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        var hasValue = has_1(nextProps, 'value');
      ...
      if (!isEqual_1(nextProps.options, this.props.options)) {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!prevState.focus && this.state.focus) {
        ...
        if (!this.state.open) {
          instance.sub('keydown', [this.openOnArrow, this.openOnSpace]);
        } else {
          instance.sub('keydown', [this.moveSelectionOnKeyDown, this.selectItemOnEnter]);
        }

        instance.sub('keydown', this.removeItemOnBackspace);
        ...
        instance.unsub('keydown', [this.openOnArrow, this.openOnSpace, this.moveSelectionOnKeyDown, this.selectItemOnEnter, this.removeItemOnBackspace]);
      } // opened / closed
      ...
      if (!prevState.open && this.state.open) {
        ...
        if (!this.state.focus) {
          instance.unsub('keydown', this.removeItemOnBackspace);
        }
      }
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      instance.unsub('keydown', [this.openOnArrow, this.openOnSpace, this.moveSelectionOnKeyDown, this.selectItemOnEnter, this.removeItemOnBackspace, this.closeOnEscape]);
      instance.unsub('click', this.closeOnDocumentClick);
    } // ----------------------------------------
    // Document Event Handlers
    // ----------------------------------------
...
defineProperty(Dropdown, "handledProps", ["additionLabel", "additionPosition", "allowAdditions", "as", "basic", "button", "children", "className", "closeOnBlur", "closeOnChange", "compact", "deburr", "defaultOpen", "defaultSearchQuery", "defaultSelectedLabel", "defaultUpward", "defaultValue", "direction", "disabled", "error", "floating", "fluid", "header", "icon", "inline", "item", "labeled", "lazyLoad", "loading", "minCharacters", "multiple", "noResultsMessage", "onAddItem", "onBlur", "onChange", "onClick", "onClose", "onFocus", "onLabelClick", "onMouseDown", "onOpen", "onSearchChange", "open", "openOnFocus", "options", "placeholder", "pointing", "renderLabel", "scrolling", "search", "searchInput", "searchQuery", "selectOnBlur", "selectOnNavigation", "selectedLabel", "selection", "simple", "tabIndex", "text", "trigger", "upward", "value", "wrapSelection"]);
Dropdown.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  allowAdditions: every([demand(['options', 'selection', 'search']), PropTypes.bool]),
  ...
  /** Primary content. */
  children: every([disallow(['options', 'selection']), givenProps({
  ...
  defaultSelectedLabel: every([demand(['multiple']), PropTypes.oneOfType([PropTypes.number, PropTypes.string])]),
  ...
  options: every([disallow(['children']), PropTypes.arrayOf(PropTypes.shape(DropdownItem.propTypes))]),
  ...
  /** Currently selected label in multi-select. */
  selectedLabel: every([demand(['multiple']), PropTypes.oneOfType([PropTypes.string, PropTypes.number])]),

  /** A dropdown can be used to select between choices in a form. */
  selection: every([disallow(['children']), demand(['options']), PropTypes.bool]),
  ...
  trigger: every([disallow(['selection', 'text']), PropTypes.node]),
...
function Select(props) {
  return React.createElement(Dropdown, _extends_1({}, props, {
    selection: true
  }));
}
...
function (_Component) {
  ...
  function TextArea() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleInput", function (e) {
      var value = get_1(e, 'target.value');
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "removeAutoHeightStyles", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "updateHeight", function () {
      ...
      var borderHeight = sum_1([borderBottomWidth, borderTopWidth].map(function (x) {
        return parseFloat(x);
...
defineProperty(TextArea, "handledProps", ["as", "autoHeight", "onChange", "onInput", "rows", "style", "value"]);
...
function (_React$Component) {
  ...
  function TransitionGroup() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleOnHide", function (nothing, childProps) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "wrapChild", function (child) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var _this$props = _this.props,
  ...
  createClass(TransitionGroup, [{
    ...
    value: function render() {
      ...
      return React.createElement(ElementType, rest, values_1(children));
    }
  }]);
...
defineProperty(TransitionGroup, "handledProps", ["animation", "as", "children", "duration"]);
TransitionGroup.propTypes = process.env.NODE_ENV !== "production" ? {
  /** An element type to render as (string or function). */
  as: as,

  /** Named animation event to used. Must be defined in CSS. */
  animation: PropTypes.oneOf(TRANSITIONS),
...
function (_Component) {
  ...
  function Transition() {
    ...
    _this = possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf(Transition)).call.apply(_getPrototypeOf2, [this].concat(_args)));

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleStart", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleComplete", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "updateStatus", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeClasses", function () {
      var _this$props = _this.props,
          animation = _this$props.animation,
          children = _this$props.children;
      var _this$state = _this.state,
      ...
      var directional = includes_1(DIRECTIONAL_TRANSITIONS, animation);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeCompletedStatus", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeInitialStatuses", function () {
      var _this$props2 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeNextStatus", function () {
      var _this$state2 = _this.state,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeStatuses", function (props) {
      var status = _this.state.status;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeStyle", function () {
      var _this$props3 = _this.props,
          children = _this$props3.children,
...
defineProperty(Transition, "handledProps", ["animation", "children", "duration", "mountOnShow", "onComplete", "onHide", "onShow", "onStart", "reactKey", "transitionOnMount", "unmountOnHide", "visible"]);
...
function (_Component) {
  ...
  function TransitionablePortal(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalClose", function () {
      _this.setState({
        portalOpen: false
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalOpen", function () {
      _this.setState({
        portalOpen: true
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTransitionHide", function (nothing, data) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTransitionStart", function (nothing, data) {
      var portalOpen = _this.state.portalOpen;
  ...
  createClass(TransitionablePortal, [{
    ...
    value: function render() {
      ...
      return React.createElement(Portal, _extends_1({}, rest, {
        open: open,
        onOpen: this.handlePortalOpen,
        onClose: this.handlePortalClose
      }), React.createElement(Transition, _extends_1({}, transition, {
        transitionOnMount: true,
...
function (_Component) {
  ...
  function Visibility() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "calculations", {
      bottomPassed: false,
      bottomVisible: false,
      fits: false,
      passing: false,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "firedCallbacks", []);

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "fire", function (_ref, value) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleUpdate", function () {
      if (_this.ticking) return;
      _this.ticking = true;
...
Breadcrumb.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  divider: every([disallow(['icon']), contentShorthand]),

  /** For use with the sections prop. Render as an `Icon` component with `divider` class instead of a `div` in
   *  Breadcrumb.Divider. */
  icon: every([disallow(['divider']), itemShorthand]),
...
function FormField(props) {
  ...
  if (control === Checkbox || control === Radio) {
    return React.createElement(ElementType, {
      className: classes
    }, createElement(control, objectSpread({}, controlProps, {
      label: label
    })));
  } // ----------------------------------------
  // Other Control
...
FormField.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  type: every([demand(['control'])] // don't strictly validate HTML types
...
FormGroup.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  widths: PropTypes.oneOf(toConsumableArray(WIDTHS).concat(['equal']))
} : {};
...
function (_Component) {
  ...
  function Input() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeIcon", function () {
      var _this$props = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "select", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleChildOverrides", function (child, defaultProps) {
      return objectSpread({}, defaultProps, child.props, {
        ref: function ref(c) {
          invoke_1(child, 'ref', c);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "partitionProps", function () {
      var _this$props3 = _this.props,
          disabled = _this$props3.disabled,
          type = _this$props3.type;
  ...
  createClass(Input, [{
    ...
    value: function render() {
      ...
      if (!isNil(children)) {
        ...
        var childElements = map_1(Children.toArray(children), function (child) {
          if (child.type !== 'input') return child;
          return cloneElement(child, _this2.handleChildOverrides(child, htmlInputProps$$1));
        });
...
GridColumn.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  computer: PropTypes.oneOf(WIDTHS),

  /** A column can sit flush against the left or right edge of a row. */
  floated: PropTypes.oneOf(FLOATS),

  /** A column can specify a width for a large screen device. */
  largeScreen: PropTypes.oneOf(WIDTHS),

  /** A column can specify a width for a mobile device. */
  mobile: PropTypes.oneOf(WIDTHS),
  ...
  widescreen: PropTypes.oneOf(WIDTHS),
...
GridRow.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  columns: PropTypes.oneOf(toConsumableArray(WIDTHS).concat(['equal'])),
...
function (_Component) {
  ...
  function Message() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleDismiss", function (e) {
  ...
  createClass(Message, [{
    ...
    value: function render() {
      ...
      return React.createElement(ElementType, _extends_1({}, rest, {
        ...
        autoGenerateKey: false
      }), (!isNil_1(header) || !isNil_1(content) || !isNil_1(list)) && React.createElement(MessageContent, null, MessageHeader.create(header, {
        autoGenerateKey: false
...
TableCell.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  textAlign: PropTypes.oneOf(without_1(TEXT_ALIGNMENTS, 'justified')),
...
function TableFooter(props) {
  ...
  return React.createElement(TableHeader, _extends_1({}, rest, {
    as: as$$1
  }));
}
...
function TableHeaderCell(props) {
  ...
  return React.createElement(TableCell, _extends_1({}, rest, {
    as: as$$1,
    className: classes
  }));
}
...
function Table(props) {
  ...
  })), React.createElement(TableBody, null, renderBodyRow && map_1(tableData, function (data, index) {
...
Table.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  size: PropTypes.oneOf(without_1(SIZES, 'mini', 'tiny', 'medium', 'big', 'huge', 'massive')),
...
Header.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  size: PropTypes.oneOf(without_1(SIZES, 'big', 'massive', 'mini')),
...
function (_Component) {
  ...
  createClass(ListItem, [{
    ...
    value: function render() {
      ...
      if (!isNil(children)) {
        return React.createElement(ElementType, _extends_1({}, rest, valueProp, {
          role: "listitem",
          className: classes,
          onClick: this.handleClick
        }), children);
      ...
      if (!isValidElement(content) && isPlainObject_1(content)) {
        return React.createElement(ElementType, _extends_1({}, rest, valueProp, {
          role: "listitem",
          className: classes,
          onClick: this.handleClick
...
ListItem.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  icon: every([disallow(['image']), itemShorthand]),

  /** Shorthand for Image. */
  image: every([disallow(['icon']), itemShorthand]),
...
function Segment(props) {
  var attached = props.attached,
      ...
      textAlign = props.textAlign,
      vertical = props.vertical;
  var classes = classnames('ui', color, size, useKeyOnly(basic, 'basic'), useKeyOnly(circular, 'circular'), useKeyOnly(clearing, 'clearing'), useKeyOnly(compact, 'compact'), useKeyOnly(disabled, 'disabled'), useKeyOnly(inverted, 'inverted'), useKeyOnly(loading, 'loading'), useKeyOnly(piled, 'piled'), useKeyOnly(raised, 'raised'), useKeyOnly(secondary, 'secondary'), useKeyOnly(stacked, 'stacked'), useKeyOnly(tertiary, 'tertiary'), useKeyOnly(vertical, 'vertical'), useKeyOrValueAndKey(attached, 'attached'), useKeyOrValueAndKey(padded, 'padded'), useTextAlignProp(textAlign), useValueAndKey(floated, 'floated'), 'segment', className);
...
var numberMap = pickBy_1(numberToWordMap, function (val, key) {
  return key <= 8;
});
/**
 * A set of steps.
...
StepGroup.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  widths: PropTypes.oneOf(toConsumableArray(keys_1(numberMap)).concat(toConsumableArray(keys_1(numberMap).map(Number)), toConsumableArray(values_1(numberMap))))
} : {};
...
defineProperty(AccordionTitle, "handledProps", ["active", "as", "children", "className", "content", "index", "onClick"]);
...
function (_Component) {
  ...
  function AccordionPanel() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTitleOverrides", function (predefinedProps) {
      return {
...
function (_Component) {
  ...
  function AccordionAccordion() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeNewIndex", function (index) {
      ...
      return includes_1(activeIndex, index) ? without_1(activeIndex, index) : toConsumableArray(activeIndex).concat([index]);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTitleClick", function (e, titleProps) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "isIndexActive", function (index) {
      var exclusive = _this.props.exclusive;
      var activeIndex = _this.state.activeIndex;
...
AccordionAccordion.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  activeIndex: every([disallow(['children']), PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.number), PropTypes.number])]),
  ...
  /** Initial activeIndex value. */
  defaultActiveIndex: every([disallow(['children']), PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.number), PropTypes.number])]),
  ...
  panels: every([disallow(['children']), PropTypes.arrayOf(PropTypes.shape({
    content: itemShorthand,
    title: itemShorthand
  }))])
} : {};
...
function Accordion(props) {
  ...
  return React.createElement(AccordionAccordion, _extends_1({}, rest, {
    className: classes
  }));
}
...
function (_Component) {
  ...
  createClass(Embed, [{
    ...
    value: function renderEmbed() {
      ...
      if (!isNil(children)) return React.createElement("div", {
        className: "embed"
      }, children);
      if (!isNil(content)) return React.createElement("div", {
        className: "embed"
      }, content);
      return React.createElement("div", {
        className: "embed"
...
Embed.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  iframe: every([demand(['source']), itemShorthand]),
  ...
  source: every([disallow(['sourceUrl']), PropTypes.oneOf(['youtube', 'vimeo'])]),
...
function (_Component) {
  ...
  function Popup() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "hideOnScroll", function (e) {
      _this.setState({
        closed: true
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalMount", function (e) {
      ...
      if (hideOnScroll) instance.sub('scroll', _this.hideOnScroll, {
        target: window
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePortalUnmount", function (e) {
      var hideOnScroll = _this.props.hideOnScroll;
      if (hideOnScroll) instance.unsub('scroll', _this.hideOnScroll, {
        target: window
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handlePopupRef", function (popupRef) {
      _this.popupCoords = popupRef ? popupRef.getBoundingClientRect() : null;

      _this.setPopupStyle();
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleTriggerRef", function (triggerRef) {
      _this.triggerRef = triggerRef;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getContext", function () {
  ...
  createClass(Popup, [{
    ...
    value: function computePopupStyle(positions) {
      ...
      if (includes_1(positions, 'right')) {
        style.right = Math.round(clientWidth - (coords.right + pageXOffset));
        style.left = 'auto';
      } else if (includes_1(positions, 'left')) {
      ...
      if (includes_1(positions, 'top')) {
        style.bottom = Math.round(clientHeight - (coords.top + pageYOffset));
        style.top = 'auto';
      } else if (includes_1(positions, 'bottom')) {
    ...
    value: function setPopupStyle() {
      ...
      if (keepInViewPort) {
        ...
        var positions = without_1(POSITIONS, position).concat([position]);
      ...
      style = mapValues_1(style, function (value) {
        return isNumber_1(value) ? "".concat(value, "px") : value;
      });
      this.setState({
        style: style,
        position: position
    ...
    value: function render() {
      ...
      var style = assign_1({}, this.state.style, this.props.style);

      var classes = classnames('ui', position, size, useKeyOrValueAndKey(wide, 'wide'), useKeyOnly(basic, 'basic'), useKeyOnly(flowing, 'flowing'), useKeyOnly(inverted, 'inverted'), 'popup transition visible', className);
      ...
      var portalProps = pick_1(unhandled, portalPropNames);

      var ElementType = getElementType(Popup, this.props);
      var popupJSX = React.createElement(ElementType, _extends_1({}, rest, {
        className: classes,
        style: style,
        ref: this.handlePopupRef
      }), children, isNil(children) && PopupHeader.create(header, {
        autoGenerateKey: false
      }), isNil(children) && PopupContent.create(content, {
        autoGenerateKey: false
      }));

      var mergedPortalProps = objectSpread({}, this.getPortalProps(), portalProps);

      return React.createElement(Portal, _extends_1({}, mergedPortalProps, {
        onClose: this.handleClose,
        onMount: this.handlePortalMount,
        onOpen: this.handleOpen,
        onUnmount: this.handlePortalUnmount,
...
defineProperty(Popup, "handledProps", ["as", "basic", "children", "className", "content", "context", "flowing", "header", "hideOnScroll", "horizontalOffset", "hoverable", "inverted", "keepInViewPort", "on", "onClose", "onMount", "onOpen", "onUnmount", "position", "size", "style", "trigger", "verticalOffset", "wide"]);
Popup.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  /** Popup size. */
  size: PropTypes.oneOf(without_1(SIZES, 'medium', 'big', 'massive')),
...
function (_Component) {
  ...
  function Progress() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "calculatePercent", function () {
      var _this$props = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "computeValueText", function (percent) {
      var _this$props2 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getPercent", function () {
      var _this$props3 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "isAutoSuccess", function () {
      var _this$props4 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderProgress", function (percent) {
      var _this$props6 = _this.props,
...
Progress.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  percent: every([disallow(['total', 'value']), PropTypes.oneOfType([PropTypes.number, PropTypes.string])]),
  ...
  size: PropTypes.oneOf(without_1(SIZES, 'mini', 'huge', 'massive')),

  /** A progress bar can show a success state. */
  success: PropTypes.bool,

  /** For use with value. Together, these will calculate the percent. Mutually excludes percent. */
  total: every([demand(['value']), disallow(['percent']), PropTypes.oneOfType([PropTypes.number, PropTypes.string])]),

  /** For use with total. Together, these will calculate the percent. Mutually excludes percent. */
  value: every([disallow(['percent']), PropTypes.oneOfType([PropTypes.number, PropTypes.string])]),
...
function (_Component) {
  ...
  function RatingIcon() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleKeyUp", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleMouseEnter", function (e) {
...
function (_Component) {
  ...
  function Rating() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleIconClick", function (e, _ref) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleIconMouseEnter", function (e, _ref2) {
...
function (_Component) {
  ...
  function Search() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleResultSelect", function (e, result) {
      invoke_1(_this.props, 'onResultSelect', e, objectSpread({}, _this.props, {
        result: result
      }));
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleSelectionChange", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleSearchChange", function (e) {
      // prevent propagating to this.props.onChange()
      e.stopPropagation();
      var minCharacters = _this.props.minCharacters;
      var open = _this.state.open;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getFlattenedResults", function () {
      var _this$props = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getSelectedResult", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "moveSelectionBy", function (e, offset) {
      var selectedIndex = _this.state.selectedIndex;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "tryOpen", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "open", function () {
      _this.trySetState({
        open: true
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "close", function () {
      _this.trySetState({
        open: false
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderSearchInput", function (rest) {
      var _this$props2 = _this.props,
          icon = _this$props2.icon,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderNoResults", function () {
      var _this$props3 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderResult", function (_ref2, index, _array) {
      ...
      return React.createElement(SearchResult, _extends_1({
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderResults", function () {
      var results = _this.props.results;
      return map_1(results, _this.renderResult);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderCategories", function () {
      var _this$props4 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderMenuContent", function () {
      var _this$props5 = _this.props,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderResultsMenu", function () {
      var open = _this.state.open;
...
defineProperty(Search, "handledProps", ["aligned", "as", "category", "categoryRenderer", "className", "defaultOpen", "defaultValue", "fluid", "icon", "input", "loading", "minCharacters", "noResultsDescription", "noResultsMessage", "onBlur", "onFocus", "onMouseDown", "onResultSelect", "onSearchChange", "onSelectionChange", "open", "resultRenderer", "results", "selectFirstResult", "showNoResults", "size", "value"]);
...
function (_Component) {
  ...
  function Sidebar() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleAnimationStart", function () {
      var _this$props = _this.props,
          duration = _this$props.duration,
          visible = _this$props.visible;
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleAnimationEnd", function () {
  ...
  createClass(Sidebar, [{
    ...
    value: function addListener() {
      instance.sub('click', this.handleDocumentClick);
    }
  }, {
    key: "removeListener",
    value: function removeListener() {
      instance.unsub('click', this.handleDocumentClick);
    }
  }, {
    key: "render",
    value: function render() {
...
defineProperty(Sidebar, "handledProps", ["animation", "as", "children", "className", "content", "direction", "duration", "onHidden", "onHide", "onShow", "onVisible", "visible", "width"]);
...
function (_Component) {
  ...
  function Sticky() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "addListeners", function (props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "removeListeners", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "update", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "assignRects", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "didReachContextBottom", function () {
      var offset = _this.props.offset;
      return _this.stickyRect.height + offset >= _this.contextRect.bottom;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "didReachStartingPoint", function () {
      return _this.stickyRect.top <= _this.triggerRect.top;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "didTouchScreenTop", function () {
      return _this.triggerRect.top < _this.props.offset;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "didTouchScreenBottom", function () {
      var bottomOffset = _this.props.bottomOffset;
      return _this.contextRect.bottom + bottomOffset > window.innerHeight;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "isOversized", function () {
      return _this.stickyRect.height > window.innerHeight;
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "pushing", function (pushing) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "stick", function (e, bound) {
      _this.setState({
        bound: bound,
        sticky: true
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "unstick", function (e, bound) {
      _this.setState({
        bound: bound,
        sticky: false
      });
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "stickToContextBottom", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "stickToContextTop", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "stickToScreenBottom", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "stickToScreenTop", function (e) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleStickyRef", function (c) {
...
defineProperty(Sticky, "handledProps", ["active", "as", "bottomOffset", "children", "className", "context", "offset", "onBottom", "onStick", "onTop", "onUnstick", "pushing", "scrollContext"]);
...
function TabPane(props) {
  ...
  return React.createElement(ElementType, _extends_1({}, calculatedDefaultProps, rest, {
    className: classes
  }), isNil(children) ? content : children);
}
...
function CardGroup(props) {
  ...
  var itemsJSX = map_1(items, function (item) {
    ...
    return React.createElement(Card, _extends_1({
      key: key
    }, item));
  });
...
FeedExtra.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  images: every([disallow(['text']), PropTypes.oneOfType([PropTypes.bool, collectionShorthand])]),
...
function Feed(props) {
  ...
  var eventElements = map_1(events, function (eventProps) {
    ...
    return React.createElement(FeedEvent, _extends_1({
      date: date,
      key: finalKey,
      meta: meta,
      summary: summary
...
function ItemGroup(props) {
  ...
  var itemsJSX = map_1(items, function (item) {
    ...
    return React.createElement(Item, _extends_1({}, itemProps, {
      key: finalKey
    }));
  });
...
function ItemImage(props) {
  ...
  return React.createElement(Image, _extends_1({}, rest, {
    size: size,
    ui: !!size,
    wrapped: true
  }));
...
StatisticGroup.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  size: PropTypes.oneOf(without_1(SIZES, 'big', 'massive', 'medium')),
...
var POSITIONS$1 = ['top left', 'top center', 'top right', 'bottom left', 'bottom center', 'bottom right', 'left center', 'right center'];
...
function SetQRstyle(dst, src, caller) {
  ...
  dst['qrposition'] = POSITIONS$1.includes(src.qrposition) ? src.qrposition : 'bottom right';
...
var Login = function (_Component) {
  ...
  function Login() {
    ...
    var _this = possibleConstructorReturn$1(this, (Login.__proto__ || Object.getPrototypeOf(Login)).call(this));
  ...
  createClass$1(Login, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      SetQRstyle(this.qrstyle, this.props, 'Login');
    }
  }, {
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      // URI for callback
      if (this.props.callbackUrl) this.baseRequestUri += "&callback=" + encodeURIComponent(this.props.callbackUrl);else this.baseRequestUri += "&callback=https%3A%2F%2F2g5198x91e.execute-api.ap-northeast-2.amazonaws.com/test?key=" + this.state.session;

      var cb = function cb(uri) {
        return _this2.setState({ trxRequestUri: uri });
      };
      ipfs.add([Buffer.from(this.baseRequestUri)], function (err, ipfsHash) {
        if (!err) {
          console.log('IPFS hash:', ipfsHash[0].hash);cb(ipfsHash[0].hash);
        } else cb(_this2.baseRequestUri);
      });
    }
  }, {
    key: 'onOpenLogin',
    value: function onOpenLogin() {
      var _this3 = this;

      if (this.props.callbackUrl) return;

      this.interval = setInterval(function () {
        _this3.checkResponse();
      }, 2000);
    }
  }, {
    key: 'onCloseLogin',
    value: function onCloseLogin() {
      if (this.props.callbackUrl) return;
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        null,
        this.state.trxRequestUri && this.props.callbackUrl && React.createElement(QRCode, { value: this.state.requestUri, size: this.qrstyle['qrsize'] }),
        this.state.requestUri && React.createElement(
          Popup,
          {
            ...
            onOpen: function onOpen() {
              return _this5.onOpenLogin();
            },
            onClose: function onClose() {
              return _this5.onCloseLogin();
            },
          ...
          React.createElement(QRCode, { value: this.state.requestUri, size: this.qrstyle['qrsize'] })
        )
      );
    }
  }]);
...
var QRCode$1 = require('qrcode.react');
var https$1 = require('https');
var constants = require('constants');
var crypto = require('crypto');

var Request = function (_Component) {
  inherits$1(Request, _Component);

  function Request() {
    classCallCheck$1(this, Request);

    var _this = possibleConstructorReturn$1(this, (Request.__proto__ || Object.getPrototypeOf(Request)).call(this));
  ...
  createClass$1(Request, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      SetQRstyle(this.qrstyle, this.props, 'Request');
    }
  }, {
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      var pubkey = this.pubkey.replace('-----BEGIN PUBLIC KEY-----', '').replace('-----END PUBLIC KEY-----', '').replace(/\s+|\n\r|\n|\r$/gm, '');
      pubkey = encodeURIComponent(pubkey);

      // URI for service
      this.baseRequestUri = "meta://information?service=" + this.props.service;
      // URI for request
      this.props.request.map(function (req) {
        _this2.baseRequestUri += "&request=" + req;
      });
      // URI for callback
      if (this.props.callbackUrl) this.baseRequestUri += "&callback=" + encodeURIComponent(this.props.callbackUrl);else this.baseRequestUri += "&callback=https%3A%2F%2F2g5198x91e.execute-api.ap-northeast-2.amazonaws.com/test?key=" + this.state.session;
      // URI for pubkey
      ...
      https$1.request({
        ...
        res.on('end', function () {
          if (data !== '') {
            clearInterval(_this4.interval);
            var json = JSON.parse(data);
            var secret = crypto.privateDecrypt({ key: _this4.privkey, padding: constants.RSA_PKCS1_PADDING }, Buffer.from(json['secret'], 'base64'));
            _this4.props.request.map(function (req) {
              if (json['data'][req] == undefined || json['data'][req] == '') return;

              var nDecipher = crypto.createDecipheriv('aes-256-ecb', secret, '');
              var data = nDecipher.update(Buffer.from(json['data'][req]['value'], 'base64'), 'base64', 'utf-8');
              data += nDecipher.final('utf-8');
              _this4.reqinfo[req] = data;
            });
            if (_this4.props.callback) {
              _this4.props.callback(_this4.reqinfo);
            }
          }
        });
      }).on('error', function (err) {
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        null,
        this.state.trxRequestUri && this.props.callbackUrl && React.createElement(QRCode$1, { value: this.state.requestUri, size: this.qrstyle['qrsize'] }),
        this.state.requestUri && React.createElement(
          Popup,
          {
            trigger: React.createElement(
            ...
            on: 'click',
            onOpen: function onOpen() {
              return _this5.onOpenRequest();
            },
            onClose: function onClose() {
              return _this5.onCloseRequest();
            },
            verticalOffset: this.qrstyle['qrvoffset'],
            position: this.qrstyle['qrposition'],
            style: {
              padding: this.qrstyle['qrpadding'],
              backgroundColor: 'white' } },
          React.createElement(QRCode$1, { value: this.state.requestUri, size: this.qrstyle['qrsize'] })
        )
      );
    }
  }]);
...
var QRCode$2 = require('qrcode.react');
var https$2 = require('https');

var SendTransaction = function (_Component) {
  inherits$1(SendTransaction, _Component);

  function SendTransaction() {
    classCallCheck$1(this, SendTransaction);

    var _this = possibleConstructorReturn$1(this, (SendTransaction.__proto__ || Object.getPrototypeOf(SendTransaction)).call(this));
  ...
  createClass$1(SendTransaction, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      SetQRstyle(this.qrstyle, this.props, 'SendTransaction');
    }
  }, {
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      // URI for to, value and data
          ...
          this.baseRequestUri += this.props.to + "&value=" + ConvertVal2Hexd(this.props.value) + "&data=" + ConvertData2Hexd(this.props.data);
        }
      // URI for usage
    ...
    key: 'onOpenSendTransaction',
    value: function onOpenSendTransaction() {
      var _this3 = this;
    ...
    key: 'onCloseSendTransaction',
    value: function onCloseSendTransaction() {
      if (this.props.callbackUrl) return;
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        null,
        this.state.trxRequestUri && this.props.callbackUrl && React.createElement(QRCode$2, { value: this.state.trxRequestUri, size: this.qrstyle['qrsize'] }),
        this.state.trxRequestUri && !this.props.callbackUrl && React.createElement(
          Popup,
          {
            trigger: React.createElement(
              Button,
            ...
            on: 'click',
            onOpen: function onOpen() {
              return _this5.onOpenSendTransaction();
            },
            onClose: function onClose() {
              return _this5.onCloseSendTransaction();
            },
            verticalOffset: this.qrstyle['qrvoffset'],
            position: this.qrstyle['qrposition'],
            style: {
              padding: this.qrstyle['qrpadding'],
              backgroundColor: 'white' } },
          React.createElement(QRCode$2, { value: this.state.trxRequestUri, size: this.qrstyle['qrsize'] })
        )
      );
    }
  }]);
...
export { Login, Request, SendTransaction };
