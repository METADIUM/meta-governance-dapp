...
function (_Component) {
  ...
  createClass(Portal, [{
    ...
    value: function render() {
      ...
      return [open ? React__default.createElement(PortalInner, {
        key: "inner",
        mountNode: mountNode,
        onMount: this.handleMount,
        onUnmount: this.handleUnmount
      }, children) : null, trigger ? React__default.createElement(Ref, {
    ...
    value: function render() {
      ...
      if (!isNil_1(label)) {
        ...
        return React__default.createElement(ElementType, _extends_1({}, rest, {
          ...
          onClick: this.handleClick
        }), labelPosition === 'left' && labelElement, React__default.createElement("button", {
...
function (_Component) {
  ...
  createClass(Responsive, [{
    ...
    value: function render() {
      ...
      if (this.isVisible()) return React__default.createElement(ElementType, rest, children);
      return null;
    }
  }]);
...
function Table(props) {
  ...
  })), React__default.createElement(TableBody, null, renderBodyRow && map_1(tableData, function (data, index) {
...
function (_Component) {
  ...
  createClass(ListItem, [{
    ...
    value: function render() {
      ...
      if (!isNil(children)) {
        return React__default.createElement(ElementType, _extends_1({}, rest, valueProp, {
          role: "listitem",
          className: classes,
          onClick: this.handleClick
        }), children);
      ...
      if (iconElement || imageElement) {
        return React__default.createElement(ElementType, _extends_1({}, rest, valueProp, {
          ...
          className: classes,
          onClick: this.handleClick
        }), iconElement || imageElement, (content || headerElement || descriptionElement) && React__default.createElement(ListContent, null, headerElement, descriptionElement, content));
      }
...
function (_Component) {
  ...
  createClass(Popup, [{
    ...
    value: function render() {
      ...
      var popupJSX = React__default.createElement(ElementType, _extends_1({}, rest, {
        className: classes,
        style: style,
  ...
  createClass$1(Login, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        'div',
        null,
        this.state.trxRequestUri && this.props.callbackUrl && React__default.createElement(QRCode, { value: this.state.requestUri, size: this.qrstyle['qrsize'] }),
        this.state.requestUri && React__default.createElement(
          Popup,
          {
          ...
          React__default.createElement(QRCode, { value: this.state.requestUri, size: this.qrstyle['qrsize'] })
        )
      );
    }
  }]);
  ...
  createClass$1(Request, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        'div',
        null,
        this.state.trxRequestUri && this.props.callbackUrl && React__default.createElement(QRCode$1, { value: this.state.requestUri, size: this.qrstyle['qrsize'] }),
        this.state.requestUri && React__default.createElement(
          Popup,
          {
            trigger: React__default.createElement(
            ...
            style: {
              padding: this.qrstyle['qrpadding'],
              backgroundColor: 'white' } },
          React__default.createElement(QRCode$1, { value: this.state.requestUri, size: this.qrstyle['qrsize'] })
        )
      );
    }
  }]);
  ...
  createClass$1(SendTransaction, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        'div',
        null,
        this.state.trxRequestUri && this.props.callbackUrl && React__default.createElement(QRCode$2, { value: this.state.trxRequestUri, size: this.qrstyle['qrsize'] }),
        this.state.trxRequestUri && !this.props.callbackUrl && React__default.createElement(
          Popup,
          {
            trigger: React__default.createElement(
              Button,
            ...
            style: {
              padding: this.qrstyle['qrpadding'],
              backgroundColor: 'white' } },
          React__default.createElement(QRCode$2, { value: this.state.trxRequestUri, size: this.qrstyle['qrsize'] })
        )
      );
    }
  }]);
